...
#define STRING_CONFIG_H_AUTHOR "(printedsolid.com and Kacper Sowa, CR-10S)" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 72.60
  #define DEFAULT_bedKi 5.99
  #define DEFAULT_bedKd 220.06
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, 18, -5 }
